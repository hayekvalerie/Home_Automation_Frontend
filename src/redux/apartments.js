...
export const Apartments = (state = { isLoading: true,
    ...
    switch (action.type) {
        ...
        case ActionTypes.POST_APARTMENT:
            var apartment = action.payload.apartment;
            return {...state, isLoading: false, errMess: null, apartments: state.apartments.concat(apartment)};
        default:
            return state;
    }
};